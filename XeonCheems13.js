...
"id":"${prefix}othermenu"}]
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"Owner\",\"url\":\"https://wa.me/6283812920234\",\"merchant_url\":\"https://www.google.com\"}"
              }
           ],
          }),
          contextInfo: {
...
"sellerJid": "6285174197856@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("6285174197856@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
